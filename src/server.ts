    ...
    toolNames.shell,
    {
      ...
      inputSchema: {
        ...
        command: z
          .string()
          .describe(
            `Shell command to run. Use devspace-runtime diagnose, smoke, costs, or jobs start/list/show/cancel for built-in diagnostics and safe parallel presets; use devspace-runtime finder <path> only on explicit request. Must not create or modify project files; use ${toolNames.edit} or ${toolNames.write} for file changes.`,
          ),
        workingDirectory: z
          .string()
          .optional()
